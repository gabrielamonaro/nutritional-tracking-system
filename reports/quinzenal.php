...
<h1 class="title">Relatório Quinzenal </h1>
...
<?php
 ...
 WHERE dia >= DATE_SUB(CURDATE(), INTERVAL 15 DAY) AND dia <= CURDATE(); 
 ";
 ...
 WHERE cd.dia >= DATE_SUB(CURDATE(), INTERVAL 15 DAY) AND cd.dia <= CURDATE();
 ";
